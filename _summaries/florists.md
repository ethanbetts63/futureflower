...
*   **Canonical Path:** /florists
*   **OG Image:** /og-images/og-homepage.webp

## Hero Section
*   **Title:** Turn one sale into *many*.
*   **Subtitle:** Extend your service beyond today's purchase. Offer scheduled deliveries, subscriptions, and prepaid plans — completely free, with zero admin.
*   **Buttons:**
    *   Learn more (with arrow down)
    *   Become a Partner

## Value Proposition (No Cost, No Admin, No Risk)
*   **Title:** No Cost, No Admin, No Risk.
*   **Points:**
...
## Comparison Section
**Title:** Stop taking a 45% haircut
**Subtitle:** Same price, more flowers. By cutting the fees big networks charge, we ensure more money ends up in the bouquet.
...
**Note:** Reward applies for all customers you signed up. No rejection fee for customers we signed up.

## Our Services
**Title:** Our Services
**Subtitle:** Everything you need to offer long-term flower commitments — without the headache.
...
## So what's the catch?
The most honest answer is that **we handle the customer**. The customers learn to use our service, pay with our system, and give us their details.
...
**Title:** For non-delivery partners.
...
No service debts. You'll receive a request for all orders from customers you sign up, but if you can't or don't want to fulfil a request, we'll pass it to another florist and give you a $5-25 referral bonus instead. Conversely, requests that other florists can't fill can come straight to you.
