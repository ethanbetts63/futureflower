        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Card message for a one-off delivery, staged before payment and copied onto the Event when it is created. Subscriptions are delivered without a card message, so this is ignored when billing_mode is 'recurring'.",
                        null=True,
                    ),
                ),
            ],
