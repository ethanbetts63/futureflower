...
const sydneyFaqs: FaqItem[] = [
  {
    ...
    answer:
      'Give us the occasion, budget, and preferences, and a Sydney florist designs a custom bouquet and delivers it on your date. Every arrangement is made fresh for that order, not pulled from a set catalogue.',
  },
  {
    question: 'Can I schedule Sydney flower delivery for a later date?',
    answer:
  ...
  },
  {
    ...
    answer:
      'No. You set the occasion, budget, and any preferences. A Sydney florist uses that brief to design something suitable from what they have available.',
  },
  {
    question: 'Which Sydney suburbs do you deliver to?',
    answer:
  ...
  {
    question: 'Is same-day flower delivery available in Sydney?',
    answer:
...
const config: OccasionLandingPageConfig = {
  seo: {
    ...
    structuredData: buildServiceSchema({
      ...
      name: 'Flower Delivery Sydney by FutureFlower',
      description:
  ...
  heroTitle: 'Sydney flowers, made to brief.',
  heroSubtext:
    'Set the occasion, budget, and preferences. A local Sydney florist designs a bouquet around them — made fresh for your order, not picked off a shelf.',
  imageOverlayTitle: 'A brief, not a catalog order.',
  imageOverlayText:
    'Your Sydney florist works from your notes to get the colour, style, and seasonal stems right.',
  trustPoints: [
    {
      icon: Sparkles,
    ...
    {
      icon: MapPin,
      title: 'Made in Sydney',
      text: 'Every order is made and delivered by a local Sydney florist — their name on the delivery, your money in their till.',
    },
    {
      icon: ShieldCheck,
  ...
  betterForEveryoneBenefits: [
    {
      ...
      text: 'Sydney florists can design around stems they already have in, so less goes to waste.',
    },
    {
      icon: Palette,
    ...
    },
    {
      ...
      text: 'You get fresh Sydney flowers chosen for the occasion, budget, and delivery date.',
    },
  ],
  howItWorksHeading: 'Three steps between you and Sydney flowers.',
  howItWorksSteps: [
    {
    ...
    {
      title: 'A Sydney florist designs it',
      text: 'We pass your brief to a florist near the delivery address. They design something suitable from the best of what\'s in season around Sydney.',
    },
    {
      title: 'Delivered on your date',
      text: 'Made fresh and delivered within the florist\'s Sydney coverage area, with your card message under their own name.',
    },
  ],
  ...
  faqTitle: 'Sydney flower delivery: answered.',
  faqs: sydneyFaqs,
};
