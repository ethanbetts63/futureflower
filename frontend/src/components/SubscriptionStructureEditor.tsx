// foreverflower/frontend/src/components/SubscriptionStructureEditor.tsx
                    ...
                    <CardContent className="space-y-8">
                        ...
                        <div className="mt-8 text-center h-12 flex flex-col items-center justify-center">
                            {(isApiCalculating || isDebouncePending) ? (
                                ...
                                <>
                                    <div className="text-2xl font-bold">${pricePerDelivery.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                                    <p className="text-xs text-gray-600">Price Per Delivery (inc. fees)</p>
                                </>
                            ) : calculationError ? (
