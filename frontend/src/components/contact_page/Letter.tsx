      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-8 text-lg text-primary-foreground">
          <div className="flex flex-col gap-4">
            ...
            <p>
              So I built FutureFlower, to turn a temporary bloom into a permanent bridge—allowing love to <span className="font-bold">defy the calendar</span> and keep a promise that even time cannot break.
            </p>
          </div>
          <div className="flex flex-col gap-4">
            <p>
              I soon realized that you don't have to be dying for it to be a great gift. FutureFlower is just as much for the son who wants to ensure his mother feels <span className="font-bold">cherished every May</span>, or the partner who wants to guarantee a decade of birthdays are celebrated with style.
            </p>
            <p>
