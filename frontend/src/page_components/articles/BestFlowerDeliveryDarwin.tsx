...
const BestFlowerDeliveryDarwin = () => {
  const meta = articleBySlug['best-flower-delivery-darwin'];

  return (
    <>
      <JsonLd path="/articles/best-flower-delivery-darwin" structuredData={{ '@type': 'Article', datePublished: meta.datePublished, dateModified: meta.dateModified, image: meta.ogImage }} />
      <ArticleLayout
      ...
      >
        <div className="text-lg text-primary-foreground space-y-6">
          ...
          <p>If a standard catalog bouquet feels too generic, <a href="/" className="underline hover:opacity-70">FutureFlower</a> lets you order by brief instead. Choose the occasion, budget, delivery date, and preferences, then a local florist designs a custom arrangement from the freshest flowers available.</p>
        </div>
      </ArticleLayout>
      <section>
