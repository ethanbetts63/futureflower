...
import { HeroPills } from '@/shared_components/HeroPills';
import { LandingHero } from '@/shared_components/LandingHero';
import { RotatingBouquetHeroImage } from '@/shared_components/RotatingBouquetHeroImage';
import {
  BetterForEveryoneSection,
  type BetterForEveryoneBenefit,
} from '@/shared_components/BetterForEveryoneSection';
